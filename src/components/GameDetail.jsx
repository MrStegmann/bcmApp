          ...
          <View className="w-full flex flex-row justify-start">
            ...
            <View className="w-2/3 flex flex-col justify-center items-center">
              ...
              <View className="w-full flex flex-row justify-center items-center gap-1 mt-1">
                ...
                <View
                  className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                    falt > 0 && "bg-danish-gold"
                  }`}
                />
                <View
                  className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                    falt > 1 && "bg-danish-gold"
                  }`}
                />
                <View
                  className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                    falt > 2 && "bg-danish-gold"
                  }`}
                />
                <View
                  className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                    falt > 3 && "bg-danish-gold"
                  }`}
                />
                <View
                  className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                    falt > 4 && "bg-danish-gold"
                  }`}
                />
                <TouchableOpacity
                  className="w-4 p-1 border border-danish-white rounded-lg"
              ...
              >
                <View className="w-1/4 flex flex-col justify-center items-center">
                  ...
                  <View className="w-full flex flex-row justify-center items-center">
                    ...
                    <Text className="text-danish-white text-sm mx-1">{`${
                      pt[`t${key}a`]
                    }`}</Text>
                    <TouchableOpacity
                      className="w-4 p-1 border border-danish-white rounded-lg"
              ...
              <View className="w-1/2 flex flex-col">
                <View className="w-2/3 flex flex-col justify-center items-center">
                  ...
                  <View className="w-full flex flex-row justify-center items-center gap-1 mt-2">
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        clubResults[quarter].falt > 0 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        clubResults[quarter].falt > 1 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        clubResults[quarter].falt > 2 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        clubResults[quarter].falt > 3 && "bg-danish-gold"
                      }`}
                    />
                  </View>
                </View>
              ...
              <View className="w-1/2 flex flex-col gap-2 pl-2">
                ...
                <View className="w-full flex flex-row justify-between items-center">
                  ...
                  <View className="w-3/4 flex flex-row justify-end items-center gap-1">
                    ...
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        opponentResults[quarter].falt > 0 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        opponentResults[quarter].falt > 1 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        opponentResults[quarter].falt > 2 && "bg-danish-gold"
                      }`}
                    />
                    <View
                      className={`w-2 h-6 border border-danish-dark-gray bg-danish-light-gray rounded-lg ${
                        opponentResults[quarter].falt > 3 && "bg-danish-gold"
                      }`}
                    />
                    <TouchableOpacity
                      onPress={() => handleChangeFalt(1)}
            ...
            {players_stats
              ...
              .map((ps) => {
                return (
                  ...
                  >
                    <View
                      className={`border border-danish-red rounded-lg w-28 p-2 ${
                        playerDetails?.id === ps.id && "bg-danish-red"
                      }`}
                    >
